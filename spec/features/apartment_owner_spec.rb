...
describe "to create an apartment hunter", type: :feature do
  ...
  it 'should be able to list an apartment' do
    visit('/')
    click_button('Signup')
    click_link('Signup')
    fill_in 'Name', with: name = Faker::Name
    ...
    fill_in 'Password confirmation', with: 'password'
    click_button 'Register'
    click_link 'List Your Apartment'
    ...
    fill_in 'Rent', with: '1100'
    fill_in 'Deposit', with: '1100'
    # fill_in 'Move-in Date', with: '08/31/2017'
    check "Furnished"
